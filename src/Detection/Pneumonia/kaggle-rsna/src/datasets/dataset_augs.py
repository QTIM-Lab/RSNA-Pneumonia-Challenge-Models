...
class DatasetAugs(Dataset):
    ...
    def __init__(self, fold: int, is_training: bool, debug: bool, img_size: int, augmentation_level=10, crop_source=1024):
        ...
        # adding in paths to our datasets
        self.categories = ["normal", "pneumonia"]
        # this csv contains the detection data for pneumonia
        samples = pd.read_csv("../../../Supervised_100_2detect2.csv")
    ...
    def get_image(self, patient_id):
        ...
        Path altered to point to our image location
        """
        try:
            img = skimage.io.imread('../../../stage_2_train_images_PNG_resize320_para/' + patient_id + '.png')
