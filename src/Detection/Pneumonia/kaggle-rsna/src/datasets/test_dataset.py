...
class TestDataset(Dataset):
    ...
    def __init__(self, debug: bool, img_size: int, csv: str):
        """
        Args:
        ...
        # change samples based on if we want all positive cases or all general 
        # self.samples = self.samples[self.samples['Target'] > 0]
        print("Debug mode, samples: /n", self.samples.head(10))
