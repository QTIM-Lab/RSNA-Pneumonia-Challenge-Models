...
MODELS = {
    ...
    "se_resnext101_dr_320": ModelInfo(
        factory=pytorch_retinanet.model_se_resnext.se_resnext101,
    ...
    "se_resnext101_dr0.75_320": ModelInfo(
        factory=pytorch_retinanet.model_se_resnext.se_resnext101,
    ...
    "se_resnext101_dr_320_without_pretrained": ModelInfo(
        factory=pytorch_retinanet.model_se_resnext.se_resnext101,
    ...
    "se_resnext101_320_bs12": ModelInfo(
        factory=pytorch_retinanet.model_se_resnext.se_resnext101,
        args=dict(num_classes=1, pretrained="imagenet"),
        img_size=320,
        batch_size=12,
    ...
    "se_resnext101_320_bs12_aug20": ModelInfo(
        factory=pytorch_retinanet.model_se_resnext.se_resnext101,
        args=dict(num_classes=1, pretrained="imagenet"),
        img_size=320,
        batch_size=12,
    ...
    "se_resnext101_320_sgd": ModelInfo(
        factory=pytorch_retinanet.model_se_resnext.se_resnext101,
        args=dict(num_classes=1, pretrained="imagenet", dropout=0.5),
        img_size=320,
        batch_size=4,
    ...
    "inc_resnet_v2_320_dr": ModelInfo(
        factory=pytorch_retinanet.model_incresv2.inceptionresnetv2,
    ...
    "se_resnext50_320_dr0.8": ModelInfo(
        factory=pytorch_retinanet.model_se_resnext.se_resnext50,
